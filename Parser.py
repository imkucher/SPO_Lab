...
class Parser:
    TYPES = [
        'VAR', 'CONST', 'ADD', 'SUB', 'LT', 'MT', 'SET', 'IF1', 'IF2', 'WHILE', 'DO', 'FOR', 'EMPTY', 'SEQ', 'EXPR',
        'PROG', 'PRINT', 'READ', 'LLPRINT'
    ]
    VAR, CONST, ADD, SUB, LT, MT, SET, IF1, IF2, WHILE, DO, FOR, EMPTY, SEQ, EXPR, PROG, PRINT, READ, LLPRINT = range(
        19)
